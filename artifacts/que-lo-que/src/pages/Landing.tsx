    ...
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full space-y-12">
        <div className="text-center space-y-6">
          ...
          <h1 className="text-5xl font-black tracking-tighter uppercase text-primary">QUE LO QUE</h1>
          <p className="text-xl italic text-gray-400">¿Qué tú quieres?</p>
        </div>

        <div className="space-y-4">
          <h2 className="text-sm font-bold text-gray-500 uppercase tracking-widest text-center">Entrar Como:</h2>
